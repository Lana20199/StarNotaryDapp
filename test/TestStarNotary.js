...
it('can add the star name and star symbol properly', async() => {
    ...
    const name = await instance.token_name.call();
    const symbol = await instance.token_symbol.call();
    const result = name === 'LanaKhan' && symbol === 'LKH';
